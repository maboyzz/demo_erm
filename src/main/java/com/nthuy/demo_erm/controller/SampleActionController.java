...
public class SampleActionController {
    ...
    public ResponseEntity<IdResponse> createRiskCategory(@Valid @RequestBody SampleActionDTO dto) throws NameExisted {
        long newId = sampleActionService.create(dto);
    ...
    public ResponseEntity<IdResponse> updateRiskCategory(@Valid @RequestBody SampleActionDTO dto) throws NameExisted {
    ...
    public ResponseEntity<ResultPaginationDTO<RiskTypeRes>> getListRiskCategory(
        ...
        return ResponseUtils.ok(sampleActionService.getListSampleAction(code, name, systemIds, isActive, pageable));
    }
}
