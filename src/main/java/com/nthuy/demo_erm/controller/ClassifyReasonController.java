...
public class ClassifyReasonController {
    ...
    public ResponseEntity<String> deleteClassifyReason(@RequestParam Long id) {
    ...
    public ResponseEntity<ResultPaginationDTO<ClassifyReasonDTO>> getClassifyReasons(
        ...
        ResultPaginationDTO<ClassifyReasonDTO> result = classifyReasonService.handleGetClassifyReason(code, name, systemIds, pageable);
